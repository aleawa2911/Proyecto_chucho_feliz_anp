...
require_once __DIR__ . '/../../models/control/reporte_caja.php';
    ...
    /*Instanciamos el modelo de reporte caja*/
    $modelo = new ReporteCajaModelo();
...
require_once __DIR__ . '/../../views/control/reporte_caja.php';
