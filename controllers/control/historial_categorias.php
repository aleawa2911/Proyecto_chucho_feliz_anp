...
require_once __DIR__ . '/../../models/control/historial_categorias.php';
    ...
    /*Instanciamos el modelo de historial categorias*/
    $modelo = new HistorialCategoriasModelo();
...
require_once __DIR__ . '/../../views/control/historial_categorias.php';
