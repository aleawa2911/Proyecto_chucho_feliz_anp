        ...
        switch ($accion) {
            case 'Insertar':
                try {
                    ...
                    $modelo->Insertar($codigo,$nombre_producto,$precio_venta,$id_categoria,$id_proveedor,$activo,$usuario_creacion);
            ...
            case 'Actualizar':
                try {
                    ...
                    $modelo->Actualizar($id_producto,$codigo,$nombre_producto,$precio_venta,$id_categoria,$id_proveedor,$usuario_actualizacion);
