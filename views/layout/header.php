...
<?php switch ($_SESSION['rol']) { 
        ...
        case 'Administrador':?>
                ...
                <div class="header-box-seccion">
                        ...
                        <div class="header-boton"><a href="/proyecto_chucho_feliz_anp/index.php?url=devoluciones" class="boton <?php if($url=='devoluciones')echo 'boton-activo'?>"><img src="/proyecto_chucho_feliz_anp/public/images/devolucion.png" alt="icono devoluciones" class="icono-seccion">Devoluciones</a></div>
                ...
                <div class="header-box-seccion">
                        ...
                        <div class="header-boton"><a href="/proyecto_chucho_feliz_anp/index.php?url=inventario" class="boton <?php if($url=='inventario')echo 'boton-activo'?>"><img src="/proyecto_chucho_feliz_anp/public/images/productos.png" alt="icono inventario" class="icono-seccion">Inventario</a></div>
