...
<head>
    ...
    <title>Detalle Compra | Chucho Feliz</title>
</head>
<body>
...
<div class="tabla-registros-box">
    <table class="tabla-registros">
        <!--Header de la tabla-->
        <tr>
            <th class="th-registros" colspan="10">Detalle de compra ID <?php echo $id_compra; ?></th>
        </tr>
        <tr>
        ...
        <!--Recibimos los detalles de la compra seleccionada-->
        <?php
        $contador_fila = 0;
