...
<div class="tabla-registros-box">
    <table class="tabla-registros">
        ...
        <tr>
            ...
            <td class="<?php if ($contador_fila % 2 === 0) echo 'td-registros-alterno'; else echo 'td-registros'; ?>"><input type="text" name="nombre_usuario" value="<?php echo $usuario['nombre_usuario']; ?>" required class="campo-texto" form="form-editar-usuarios"></td>
            <td class="<?php if ($contador_fila % 2 === 0) echo 'td-registros-alterno'; else echo 'td-registros'; ?>"><input type="email" name="correo" value="<?php echo $usuario['correo']; ?>" required class="campo-texto" form="form-editar-usuarios"></td>
            <td class="<?php if ($contador_fila % 2 === 0) echo 'td-registros-alterno'; else echo 'td-registros'; ?>">
            ...
            <td class="th-registros"><?php echo $usuario['id_usuario']; ?></td>
            <td class="<?php if ($contador_fila % 2 === 0) echo 'td-registros-alterno'; else echo 'td-registros'; ?>"><?php echo $usuario['nombre_completo']; ?></td>
            <td class="<?php if ($contador_fila % 2 === 0) echo 'td-registros-alterno'; else echo 'td-registros'; ?>"><?php echo $usuario['nombre_usuario']; ?></td>
